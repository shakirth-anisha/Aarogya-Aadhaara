...
public class login_p extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(v -> {
            if (chosenRole.equals("Doctor")) {
                ...
                Intent intent = new Intent(login_p.this, homepage.class);
                startActivity(intent);
            } else if (chosenRole.equals("Patient")) {
                // Navigate to homepage_p
                Intent intent = new Intent(login_p.this, homepage_p.class);
                startActivity(intent);
            }
        });
    }
    ...
    public void onClick_signup(View v) {
        Intent intent = new Intent(login_p.this, signup.class);
        startActivity(intent);
    }
}